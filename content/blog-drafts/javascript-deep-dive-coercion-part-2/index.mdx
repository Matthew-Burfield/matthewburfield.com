...
I think one of the first coercions I ever used as a JavaScript programmer (even though I didn't really understand what it meant at the time), was converting a number to a string.
